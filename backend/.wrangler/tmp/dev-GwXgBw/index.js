...
// .wrangler/tmp/bundle-UUl1pt/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\HP\\Desktop\\Exponus\\Exponus\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\HP\\Desktop\\Exponus\\Exponus\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-UUl1pt/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-UUl1pt/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
blogRoutes.use("/*", async (c, next) => {
  ...
  const user = await verify2(authToken, c.env.JWT_SECRET);
  if (user) {
...
app.route("/api/v1/post", blogRoutes);
var src_default = app;
